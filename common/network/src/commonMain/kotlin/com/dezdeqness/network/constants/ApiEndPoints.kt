...
object ApiEndPoints {
    ...
    const val VIEWS_TIMECODES = "${ACCOUNTS_ME}views/timecodes"
    const val RELEASE_EPISODES_TIMECODES = "${ANIME}releases/{id}/episodes/timecodes"
    ...
    const val FRANCHISES = "${ANIME}franchises"
    const val FRANCHISES_RANDOM = "${ANIME}franchises/random"
    const val FRANCHISE_BY_ID = "${ANIME}franchises/{id}"
    ...
    const val PROMOTIONS = "media/promotions"
